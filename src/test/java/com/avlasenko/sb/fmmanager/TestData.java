...
public class TestData {
    ...
    public static final Individual INDIVIDUAL_NEW = new Individual(4, true, "Vasilii", "Vasilenko", "Vasilovych", "566556", DateTimeUtils.toLocalDate("1990-5-5"), "B. Tserkva", true, 980, false, DateTimeUtils.toLocalDate("2016-8-3"));
    ...
    public static final Individual INDIVIDUAL_1_UPDATED = new Individual(4, "Anton", "Antonenko", "Antonovych", "12365474", DateTimeUtils.toLocalDate("1988-5-5"), "Cherkassy", true, 980, false);
    ...
    static {
        ...
        INDIVIDUAL_2.setEntrepreneurInfo(ENTREPRENEUR_INFO_1);
